package dialog.lvqiang.com.mater_dialog;
...
import com.afollestad.materialdialogs.commons.folderselector.FileChooserDialog;
import com.afollestad.materialdialogs.commons.folderselector.FolderChooserDialog;
        ...
        new MaterialDialog.Builder(this)
                ...
                .onNegative(new MaterialDialog.SingleButtonCallback(){
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        Toast.makeText(MainActivity.this,which.name(),Toast.LENGTH_LONG).show();
                    }
                })
                .show();
    }
